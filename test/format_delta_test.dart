...
void main() {
  group('formatDelta', () {
    ...
    test('Custom timezone label is used when provided', () {
      ...
      expect(result, 'DELTA: PST + 02:30:00');
    });
  });
}
