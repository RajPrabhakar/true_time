...
class _HomeThemeMenuState extends State<HomeThemeMenu> {
  ...
  List<AppThemeType> _filteredThemes() {
    final all = ThemeDefinitions.getAllThemes();
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final cardHeight = constraints.maxHeight * (compact ? 0.68 : 0.72);
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      padding: EdgeInsets.only(right: compact ? 96 : 116),
                  ...
                  children: [
                    ...
                    Transform.scale(
                      ...
                      child: Switch.adaptive(
                        ...
                        inactiveTrackColor:
                            widget.themeColors.secondaryTextColor.withValues(alpha: 0.2),
                      ),
                    ),
                  ],
                ),
